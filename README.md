...
```
bash-5.1$ kubectl get images.kpack.io
NAME              LATESTIMAGE                                                                                             READY
petclinic-image   index.docker.io/seletreby/app@sha256:752ef465925b57c61af5dcfad6fda2ce79a7f1027a93031f47053ccfe26b8f58   True
```
...
spec:
  template:
    spec:
      containers:
        - image: index.docker.io/seletreby/app@sha256:752ef465925b57c61af5dcfad6fda2ce79a7f1027a93031f47053ccfe26b8f58  # generated by kpack
```
...
```
argocd app create petclinic --repo https://github.com/seletreby310/spring-petclinic-1 --path knative --dest-server https://kubernetes.default.svc --dest-namespace default
```
...
```
kubectl -n contour-external port-forward svc/envoy 8081:80
curl -H "Host: petclinic-knative.default.example.com" localhost:8081
```
